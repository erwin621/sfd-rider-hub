...
No database setup needed — data is stored in `database.json`.

**First run — create your accounts through the app:**

1. **Admin account** — Click **Admin** → **Create Admin Account** → fill in display name, username, and password → **Create Account**
2. **Tech accounts** — Click **Technician** → **Register as Technician** → fill in full name and a 4–6 digit PIN → **Create Account**

Accounts are stored securely with bcrypt hashing. No demo credentials exist — all accounts must be registered.
